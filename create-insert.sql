...
-- -----------------------------------------------------
-- Table `locacao_midias`.`ator_atriz`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `locacao_midias`.`ator_atriz` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(45) NOT NULL,
  `sobrenome` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `locacao_midias`.`midia` (
  ...
  `anoLancamento` VARCHAR(100) NOT NULL,
  `codigoBarras` VARCHAR(13) NOT NULL,
  `duracaoEmMinutos` INT NOT NULL,
  `ator_atriz_principal` INT NOT NULL,
  `ator_atriz_coadjuvante` INT NOT NULL,
  ...
  INDEX `fk_midia_ator_atriz_principal_idx` (`ator_atriz_principal` ASC),
  INDEX `fk_midia_ator_atriz_coadjuvante_idx` (`ator_atriz_coadjuvante` ASC),
  ...
  CONSTRAINT `fk_midia_ator_atriz_principal`
    FOREIGN KEY (`ator_atriz_principal`)
    REFERENCES `locacao_midias`.`ator_atriz` (`id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_midia_ator_atriz_coadjuvante`
    FOREIGN KEY (`ator_atriz_coadjuvante`)
    REFERENCES `locacao_midias`.`ator_atriz` (`id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
...
START TRANSACTION;
USE `locacao_midias`;
INSERT INTO `locacao_midias`.`cliente` (`id`, `nome`, `sobrenome`, `dataNascimento`, `cpf`, `email`, `logradouro`, `numero`, `bairro`, `cep`, `cidade_id`) VALUES (1, 'João', 'da Silva', '1999-10-10', '111.111.111-11', 'joao@joao.com.br', 'Rua Hermenegildo Cossi', '750', 'Jardim Fortaleza', '13880-000', 1);
INSERT INTO `locacao_midias`.`cliente` (`id`, `nome`, `sobrenome`, `dataNascimento`, `cpf`, `email`, `logradouro`, `numero`, `bairro`, `cep`, `cidade_id`) VALUES (2, 'Maria', 'Rodrigues', '1974-05-16', '222.222.222-22', 'mariarod@gmail.com', 'Rua Patrocínio Rodrigues', '120', 'Centro', '13880-000', 1);
INSERT INTO `locacao_midias`.`cliente` (`id`, `nome`, `sobrenome`, `dataNascimento`, `cpf`, `email`, `logradouro`, `numero`, `bairro`, `cep`, `cidade_id`) VALUES (3, 'Marcela', 'dos Santos', '1985-09-25', '333.333.333-33', 'mdossantos@uol.com.br', 'Rua Primeirod de Maio', '219', 'Centro', '13880-000', 1);

COMMIT;


-- -----------------------------------------------------
-- Data for table `locacao_midias`.`ator_atriz`
-- -----------------------------------------------------
START TRANSACTION;
USE `locacao_midias`;
INSERT INTO `locacao_midias`.`ator_atriz` (`id`, `nome`, `sobrenome`, `dataEstreia`) VALUES (1, 'Keanu', 'Reeves', '1980-10-10');
INSERT INTO `locacao_midias`.`ator_atriz` (`id`, `nome`, `sobrenome`, `dataEstreia`) VALUES (2, 'Laurence', 'Fishburne', '1970-10-10');
INSERT INTO `locacao_midias`.`ator_atriz` (`id`, `nome`, `sobrenome`, `dataEstreia`) VALUES (3, 'Daniel', 'Radcliffe', '1999-10-10');
INSERT INTO `locacao_midias`.`ator_atriz` (`id`, `nome`, `sobrenome`, `dataEstreia`) VALUES (4, 'Emma', 'Watson', '2000-10-10');
...
START TRANSACTION;
USE `locacao_midias`;
INSERT INTO `locacao_midias`.`classificacao_interna` (`id`, `descricao`, `valorAluguel`) VALUES (1, 'Lançamento', 10.00);
INSERT INTO `locacao_midias`.`classificacao_interna` (`id`, `descricao`, `valorAluguel`) VALUES (2, 'Padrão', 5.50);
INSERT INTO `locacao_midias`.`classificacao_interna` (`id`, `descricao`, `valorAluguel`) VALUES (3, 'Promoção', 4.00);
...
START TRANSACTION;
USE `locacao_midias`;
INSERT INTO `locacao_midias`.`midia` (`id`, `titulo`, `anoLancamento`, `codigoBarras`, `duracaoEmMinutos`, `ator_atriz_principal`, `ator_atriz_coadjuvante`, `genero_id`, `classificacao_etaria_id`, `tipo_id`, `classificacao_interna_id`) VALUES (1, 'Harry Potter e a Pedra Filosofal', '2001', '1231231231231', 125, 3, 4, 2, 1, 1, 2);
INSERT INTO `locacao_midias`.`midia` (`id`, `titulo`, `anoLancamento`, `codigoBarras`, `duracaoEmMinutos`, `ator_atriz_principal`, `ator_atriz_coadjuvante`, `genero_id`, `classificacao_etaria_id`, `tipo_id`, `classificacao_interna_id`) VALUES (2, 'Matrix', '1999', '4564564564564', 136, 1, 2, 3, 2, 2, 3);
